...
def main() -> None:
    ...
    if port and service_url:
        ...
        # If we are in the middle of a deployment, just start the listener
        # without setting the webhook. The second deployment pass will set it.
        if os.environ.get("IS_DEPLOYING", "false").lower() == "true":
